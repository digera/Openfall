...
// Server-side bots. By default, each team spawns exactly BOTS_PER_TEAM bots,
// independent of human count. This can be overridden with the BOTS_PER_TEAM
...
BOTS_PER_TEAM :: 1
MAX_BOTS :: TEAM_COUNT * max(BOTS_PER_TEAM, TEAM_SIZE)
...
// Spawn exactly BOTS_PER_TEAM bots on each team, independent of human count.
