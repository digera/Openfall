...
**Target brackets:** The sticky target is marked in the world with four corner brackets around the wisp. Enemy targets (hostile team) are marked with red brackets; friendly targets (same team, not yourself) are marked with green brackets. The brackets are drawn analytically in the shader as part of the raymarched visual language, readable at arena engagement distances. No brackets appear when there is no target or when the target is dead.
